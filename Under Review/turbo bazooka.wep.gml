#define init
	global.sprTurboBazooka = sprite_add_weapon("../Sprites/Bazooka/TurboBazooka.png", 8, 5);
	
	global.sprMiniRocket = sprite_add("../Sprites/Projectiles/Bazooka/MiniRocket.png", 1, 7, 3);

#define weapon_name
	return "TURBO BAZOOKA"; // Name
...
#define weapon_fire
	...
	with instance_create(x, y, CustomProjectile) { 
		motion_set(other.gunangle + (random_range(-8, 8) * other.accuracy), 2)
		creator = other
		team = other.team
...
#define weapon_sprt
	return global.sprTurboBazooka; // Wep Sprite