#define init
	global.sprNitroNukeLauncher = sprite_add_weapon("../Sprites/Nuke/NitroNukeLauncher.png", 8, 15);
	
	global.sprMiniNuke = sprite_add("../Sprites/Projectiles/Nuke/MiniNuke.png", 1, 7, 3);

#define weapon_name
	return "NITRO NUKE LAUNCHER"; // Name
...
#define weapon_fire
	...
	repeat(2) with instance_create(x, y, CustomProjectile) {
		motion_set(other.gunangle + (random_range(-96, 96) * other.accuracy), 2)
		creator = other
...
#define weapon_sprt
	return global.sprNitroNukeLauncher; // Wep Sprite