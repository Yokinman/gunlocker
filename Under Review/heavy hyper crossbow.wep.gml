#define init
global.sprHeavyHyperCrossbow = sprite_add_weapon("../Sprites/HeavyBolt/HeavyHyperCrossbow.png", 2, 4);
global.sprHeavyHyperBolt = sprite_add("../Sprites/Projectiles/HeavyBolt/HeavyHyperBolt.png", 1, 8, 4);

#define weapon_name
return "HEAVY HYPER CROSSBOW"; // Name
...
// Just a copy of the normal hyper crossbow code but with some heavy shit
			...
			if(team != other.team && distance_to_object(other) <= 0){
				...
				if(my_health > 0){
					...
					with instance_create(x,y,BoltStick){
						target = other;
						sprite_index = global.sprHeavyHyperBolt;
...
#define weapon_sprt
return global.sprHeavyHyperCrossbow; // Wep Sprite