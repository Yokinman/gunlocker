...
repeat(3) if instance_exists(self){
	...
	repeat(3) with instance_create(x - (lengthdir_x(random_range(1,2), gunangle + 90) * other.right), y - (lengthdir_y(random_range(1,2), gunangle + 90) * other.right), Splinter){ // Splinters
...
#define weapon_text
return "SPINY BURST"; // Loading Tip